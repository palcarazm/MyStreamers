<tr>
    ...
    <td class="align-middle">
        <div class="btn-group">
            ...
            <button btn-action-type="send" btn-action="user-lock" btn-method="PATCH" btn-uri="/api/user/v1/lock?id=<?php echo $this->getID(); ?>" btn-data="{}" class="btn btn-warning" <?php echo $this->isBlocked() ? 'style="display:none;"' : ''; ?> title="Bloquear Usuario"><i class="fas fa-lock"></i></button>
            <button btn-action-type="send" btn-action="user-unlock" btn-method="PATCH" btn-uri="/api/user/v1/unlock?id=<?php echo $this->getID(); ?>" btn-data="{}" class="btn btn-warning" <?php echo $this->isBlocked() ? '' : 'style="display:none;"'; ?> title="Desbloquear Usuario"><i class="fas fa-lock-open"></i></button>
