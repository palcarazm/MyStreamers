...
<div class="card-body">
    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item step todo" id="finalMessage">
            ...
            <p><span class="badge badge-warning text-white"><i class="fas fa-exclamation-circle  mr-1"></i>Por seguridad, vamos a bloquear el acceso a esta sección para que nadie pueda modificar la configuración del sitio sin estar autenticado.</span></p>
        </li>
        <!-- Fin finalMessage -->
    </ul>
