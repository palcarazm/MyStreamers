...
<div class="row">
    <main class="col-lg-7 col-xl-8">
        ...
        <div class="card mb-3">
            <div class="card-header text-white bg-primary d-flex justify-content-between align-items-center">
                <h5 class="mb-0">En directo <span class="badge badge-pill badge-light">5</span></h5>
                <a class="btn btn-outline-light btn-sm" href="/miembros">Ver más</a>
            </div>
            <div class="card-body">
    ...
    <?php endif; ?>
        <div class="card mb-3">
            <div class="card-header text-white bg-primary d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Últimos videos</h5>
